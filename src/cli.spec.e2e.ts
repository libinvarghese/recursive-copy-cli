  ...
  describe('bootstrap-cli', () => {
    ...
    describe('options', () => {
      ...
      it('should expand symlinked source files if expand is specified', async () => {
        ...
        expect(`${_destPath}/expanded-${_testItem}`).to.not.be.symlink();
      ...
      it('should expand nested symlinks if expand is specified', async () => {
        ...
        expect(`${_destPath}/expanded-${_testItem}/file`).to.not.be.symlink();
        expect(`${_destPath}/expanded-${_testItem}/directory`).to.not.be.symlink();
        expect(`${_destPath}/expanded-${_testItem}/nested/directory`).to.not.be.symlink();
      });
    });
